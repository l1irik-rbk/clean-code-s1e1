...
var taskInput=document.querySelector(".add__wrapper-task");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="item__task-input-checkbox"
    ...
    deleteButtonImg.className="delete__btn-img"
